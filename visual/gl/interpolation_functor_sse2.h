...
struct sse2_bilinear_fixy_functor {
	...
	inline __m128i operator()( const tjs_uint32* src1, const tjs_uint32* src2, __m128i mstart ) const {
		...
		tjs_int o0 = _mm_cvtsi128_si32(_mm_shuffle_epi32(offset, 0xFF));
		tjs_int o1 = _mm_cvtsi128_si32(_mm_shuffle_epi32(offset, 0xAA));
		tjs_int o2 = _mm_cvtsi128_si32(_mm_shuffle_epi32(offset, 0x55));
		tjs_int o3 = _mm_cvtsi128_si32(offset);
